...
import { Container } from 'components/App/Migration/SelectBox'
  ...
  return (
    <Wrapper>
      ...
      <SlippageTolerance
        ...
        bgColor={'linear-gradient(90deg, #E29C53 0%, #CE4C7A 100%)'}
      />
    </Wrapper>
  )
}
